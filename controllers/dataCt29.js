...
const developer=require('./developer29')
const {    
       shopmastersignup,
       shopsignup,
       shoplogin,
...
exports.deletemany=(req,res,next)=>{deletemany(req,res,next)}
...
exports.updatetransactionstatus=(req,res,next)=>{updatetransactionstatus(req,res,next)}
exports.updategroup=(req,res,next)=>{updategroup(req,res,next)}

//==========================
exports.shopmastersignup=(req,res,next)=>{shopmastersignup(req,res,next)}
...
exports.getuserbyid=(req,res,next)=>{getuserbyid(req,res,next)}
...
exports.changeuserpassword=(req,res,next)=>{changeuserpassword(req,res,next)}

exports.updateformtemplate=(req,res,next)=>{updateformtemplate(req,res,next)}

exports.payshopfee=(req,res,next)=>{payshopfee(req,res,next)}
exports.getshoppayment=(req,res,next)=>{getshoppayment(req,res,next)}
exports.updateshoppayment=(req,res,next)=>{updateshoppayment(req,res,next)}
exports.deleteshoppayment=(req,res,next)=>{deleteshoppayment(req,res,next)}

exports.shoploginforpayment=(req,res,next)=>{shoploginforpayment(req,res,next)}
exports.resetshoppassword=(req,res,next)=>{resetshoppassword(req,res,next)}
exports.createshoppassword=(req,res,next)=>{createshoppassword(req,res,next)}